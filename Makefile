...
SRCS_MATHS := utils_maths.c ray.c cal_rays.c lights.c matrice_rotation.c plane.c cylinder.c movements.c fov.c intersect.c on_path.c set_closest.c shadows.c vectors_utils.c vectors_magic.c
