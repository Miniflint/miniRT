...
.LFB60:
	...
	xorl	%eax, %eax
#APP
# 62 "srcs/maths/utils_maths.c" 1
	movsd (%rdi), %xmm0;movsd 8(%rdi), %xmm1;mulsd (%rsi), %xmm0;mulsd 8(%rsi), %xmm1;addsd %xmm1, %xmm0;movsd 16(%rdi), %xmm1;mulsd 16(%rsi), %xmm1;addsd %xmm1, %xmm0;movsd %xmm0, (%rsp);
# 0 "" 2
#NO_APP
	movsd	(%rsp), %xmm0
	movq	8(%rsp), %rax
